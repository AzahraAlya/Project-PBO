...
public class DataModel {
    ...
    public void addAkunPengguna(Peminjam pinjam) throws SQLException{
        ...
        statePeminjam.setString(3,pinjam.getTanggalPinjam());
    ...
    public void addAkunPengguna(Petugas pinjam) throws SQLException{
        ...
        PreparedStatement stateBuku = conn.prepareStatement(InsertBuku);
        stateBuku.setInt(1,pinjam.getBook().get(0).getIDbuku());
        stateBuku.setString(2,pinjam.getBook().get(0).getJudulbuku());
        stateBuku.setInt(3,pinjam.getIDpengguna());
        stateBuku.execute();
...
//    }
    ...
    public void addBuku(int penggunaID, Buku book) throws SQLException{
        String insertHolder = "INSERT INTO buku (id_pengguna,id_buku,judul_buku)"
                + " VALUES (?,?,?)";
  
        PreparedStatement stmtHolder = conn.prepareStatement(insertHolder);
        stmtHolder.setInt(1, penggunaID);
        stmtHolder.setInt(2, book.getIDbuku());
        stmtHolder.setString(3, book.getJudulbuku());
        stmtHolder.execute();
